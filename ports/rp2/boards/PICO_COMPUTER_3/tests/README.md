...
| `test_cursor.py` | automatic | `pccursor` mouse pointer: hot-point placement, save/restore on move, hide/show/erase/off, shape/colour swap, corner clipping, all 4 modes (pixel-verified via `move()`, no mouse needed) |

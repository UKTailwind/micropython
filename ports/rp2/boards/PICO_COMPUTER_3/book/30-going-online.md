# Chapter 30 — Going online: Wi-Fi and the internet
...
Chapter 29 left you setting the clock by hand. Never again:
...
timer is chapter 29's poll-loop clock.)
...
![Two ways to use the network. **HTTP** (earlier in the chapter) is a one-shot question and answer with a server; **MQTT** lets many machines chat by *topic* through a shared broker that relays each message to every subscriber.](figs/30-net.png)
...
2. **The weather diary.** Once an hour (chapter 29's cron-junior),

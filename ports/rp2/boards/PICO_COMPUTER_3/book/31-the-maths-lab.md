# Chapter 31 — Numbers at speed: the maths lab
...
flatland, and a `PID` controller that chapter 32's world of motors is
...
2. The promised speed race: square 10,000 numbers with a Python
   ...
   RAM (chapter 35 will have things to say).
...
4. **The lab notebook.** Marry this chapter to chapter 30's weather

# Example programs, extracted from the book chapters
...
## ch05 -- Chapter 5 — Writing real programs: the editor
...
- `01-bouncer.py` (7 lines)
- `02-listing.py` (4 lines)
- `03-listing.py` (8 lines)
- `04-listing.py` (8 lines)
- `05-guess.py` (16 lines)

## ch08 -- Chapter 8 — Repeating yourself: loops

- `01-countdown.py` (7 lines)
- `02-blink.py` (7 lines)
- `03-guess.py` (20 lines)
- `04-listing.py` (5 lines)
- `05-listing.py` (7 lines)
- `06-listing.py` (4 lines)
- `07-times.py` (23 lines)

## ch09 -- Chapter 9 — Turtle graphics: loops you can see

- `01-square.py` (8 lines)
- `02-square.py` (6 lines)
...
- `04-hiscore.py` (19 lines)
- `05-quiz2.py` (17 lines)

## ch11 -- Chapter 11 — Functions: building your own commands

- `01-learn.py` (10 lines)
- `02-listing.py` (10 lines)
- `03-listing.py` (7 lines)
- `04-listing.py` (5 lines)
...
- `02-handy.py` (10 lines)
- `03-listing.py` (7 lines)
- `04-listing.py` (5 lines)
- `05-listing.py` (6 lines)
- `06-listing.py` (7 lines)
- `07-fragment.py` (3 lines) -- fragment shown mid-explanation, not standalone
- `08-fragment.py` (2 lines) -- fragment shown mid-explanation, not standalone

## ch14 -- Chapter 14 — Objects: a gentle introduction to classes

- `01-listing.py` (1 lines)
- `02-hero.py` (11 lines)
- `03-listing.py` (18 lines)
- `04-listing.py` (4 lines)
- `05-fragment.py` (2 lines) -- fragment shown mid-explanation, not standalone
- `06-listing.py` (7 lines)
- `07-duel.py` (34 lines)
- `08-bank.py` (19 lines)

## ch15 -- Chapter 15 — The screen up close
